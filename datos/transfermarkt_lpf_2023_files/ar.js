(function() {
    ...
    // ── Configuration ──────────────────────────────────────────────────
    const S3_CONFIG_URL = 'https://tmsi.akamaized.net/js/ad-setup/prebid/config/ar.json';
    ...
    // "/58778164/transfermarkt.com.ar/transfermarkt.com.ar_d_side_1" -> "d_side_1"
    function getShortDivId(adUnitCode) {
        var match = adUnitCode.match(/transfermarkt\.com\.ar_(.+)$/);
    ...
    function defineGPTSlots(config) {
        return new Promise(function(resolve) {
            googletag.cmd.push(function() {
                ...
                googletag.pubads().setTargeting('URL', ['www.transfermarkt.com.ar']);
